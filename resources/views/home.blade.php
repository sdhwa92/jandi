                ...
                <div class="mt-3 event-list">
                  <div class="d-flex justify-content-between align-items-center">
                    <div class="d-flex flex-row align-items-center"> 
                      {{-- <span class="star"><i class="fa fa-futbol-o blue"></i></span> --}}
                      <div class="d-flex flex-column"> <span>{{ $event->name }}</span>
                        <div class="d-flex flex-row align-items-center time-text"> 
                          <small>{{ $event->event_date . ' ' . $event->start_time }}</small> 
                          {{-- <span class="dots"></span> <small>viewed Just now</small>  --}}
                          {{-- <span class="dots"></span> <small>Edited 15 minutes ago</small> --}}
                        </div>
                      </div>
                    </div>
